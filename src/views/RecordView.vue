...
<template>
  <div class="mt-10">
    <van-collapse v-model="store.activeNames">
      ...
      <van-collapse-item title="比赛名称" name="3">
        <van-cell-group inset>
          <van-field v-model="store.game" label="请输入或选择" placeholder="比赛名称" />
          <div class="mt-3 grid gap-2 w-full tags" v-if="store.recordedGames.length">
